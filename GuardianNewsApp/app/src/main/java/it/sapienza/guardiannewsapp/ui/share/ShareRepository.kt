...
import it.sapienza.guardiannewsapp.CHANNEL_DESCRIPTION
import it.sapienza.guardiannewsapp.CHANNEL_ID
import it.sapienza.guardiannewsapp.NOTIFICATION_ID
    ...
    private fun showNotification(email: String) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder = Notification.Builder(c, CHANNEL_ID)
                .setSmallIcon(it.sapienza.guardiannewsapp.R.drawable.share_colored)
